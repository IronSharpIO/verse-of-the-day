package pro.fullstackdevs.verse_of_the_day.utils

object BibleStructure {
    val structure: Map<String, List<Int>> = mapOf(
        ...
        "Numbers" to listOf(54, 34, 51, 49, 31, 27, 89, 26, 23, 36, 35, 16, 33, 45, 41, 50, 13, 32, 22, 29, 35, 41, 30, 25, 18, 65, 23, 31, 39, 17, 54, 42, 56, 29, 34, 13),
        ...
        "2 Kings" to listOf(18, 25, 27, 44, 27, 33, 20, 29, 37, 36, 20, 21, 25, 29, 38, 20, 41, 37, 37, 21, 26, 20, 37, 20, 30),
        ...
        "Isaiah" to listOf(31, 22, 26, 6, 30, 13, 25, 22, 21, 34, 16, 6, 22, 32, 9, 14, 14, 7, 25, 6, 17, 25, 18, 23, 12, 21, 13, 29, 24, 33, 9, 20, 24, 17, 10, 22, 38, 22, 8, 31, 29, 25, 28, 28, 25, 13, 15, 22, 26, 11, 23, 15, 12, 17, 13, 12, 21, 14, 21, 22, 11, 12, 19, 11, 25, 24, 23, 28, 12, 19),
...
object RandomVerseGenerator {

    fun getRandomVerseReference(): String {
        val book = BibleStructure.structure.keys.random()
        val chapters = BibleStructure.structure[book]!!
        val chapterIndex = chapters.indices.random()
        val verseCount = chapters[chapterIndex]
        val verseNumber = (1..verseCount).random()
        return "$book ${chapterIndex + 1}:$verseNumber"
    }
}
